...
#define THC_GENERIC_FILE "generic/WeightedClassNLLCriterion.cu"
#else
...
void THNN_(WeightedClassNLLCriterion_updateOutput)(
  ...
  if (THCTensor_(nDimension)(state, input) == 1) {
    cunn_WeightedClassNLLCriterion_updateOutput_kernel1<real>
    ...
    cunn_WeightedClassNLLCriterion_updateOutput_kernel<real, accreal>
...
void THNN_(WeightedClassNLLCriterion_updateGradInput)(
  ...
  if (THCTensor_(nDimension)(state, input) == 1) {
    cunn_WeightedClassNLLCriterion_updateGradInput_kernel1<real>
      <<<1, 1, 0, THCState_getCurrentStream(state)>>>(
        gradInput_data,
        weights_data,
        target_data,
    ...
    cunn_WeightedClassNLLCriterion_updateGradInput_kernel<real>
      <<<1, NTHREADS, 0, THCState_getCurrentStream(state)>>>(
        gradInput_data,
        target_data,
        weight_map_data,
